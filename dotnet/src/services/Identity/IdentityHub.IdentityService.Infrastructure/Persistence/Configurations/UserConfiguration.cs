    ...
    internal sealed class UserConfiguration : IEntityTypeConfiguration<User>
    {
        public void Configure(EntityTypeBuilder<User> builder)
        {
            ...
            builder.Property(s => s.Login)
                   ...
                   .HasConversion(outDB => outDB.Value, inDB => new Login(inDB));

            builder.Property(s => s.UserName)
                   .HasColumnName("Name")
                   .HasMaxLength(UserName.MAX_LENGTH)
                   .HasConversion(outDB => outDB.Value, inDB => new UserName(inDB));

            builder.Property(s => s.Email)
                   .HasColumnName("Email")
                   .UseCollation(PostgresConstants.COLLATION_NAME)
                   .HasConversion(outDB => outDB.Value, inDB => new Email(inDB));
            ...
            builder.Property(s => s.NumberPhone)
                   ...
                   .HasConversion
                        (
                            ...
                            inDB => string.IsNullOrWhiteSpace(inDB) ? null : new NumberPhone(inDB)
                        );
